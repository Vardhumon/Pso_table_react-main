            ...
            <table className="table table-hover table-light table-bordered w-75 mt-5">
                <thead className='ms-2'>
                    <tr className='ms-2 text-center table-primary sticky-top'>
                        ...
                        <th className='text-center' scope='col' style={{ minWidth: "100px" }}>CO1<br></br>Total</th>
                        <th className='text-center' scope='col' style={{ minWidth: "100px" }}>CO2<br></br>UT1</th>
                        <th className='text-center' scope='col' style={{ minWidth: "100px" }}>CO2<br></br>CW</th>
                        <th className='text-center' scope='col' style={{ minWidth: "100px" }}>CO2<br></br>Total</th>
                        <th className='text-center' scope='col' style={{ minWidth: "100px" }}>CO3<br></br>UT2</th>
                        <th className='text-center' scope='col' style={{ minWidth: "100px" }}>CO3<br></br>CW</th>
                        <th className='text-center' scope='col' style={{ minWidth: "100px" }}>CO3<br></br>Total</th>
                        <th className='text-center' scope='col' style={{ minWidth: "100px" }}>CO4<br></br>UT2</th>
                        <th className='text-center' scope='col' style={{ minWidth: "100px" }}>CO4<br></br>CW</th>
                        <th className='text-center' scope='col' style={{ minWidth: "100px" }}>CO4<br></br>Total</th>
                        <th className='text-center' scope='col' style={{ minWidth: "100px" }}><br></br>{ }</th>
                        <th className='text-center' scope='col' style={{ minWidth: "100px" }}>CO5<br></br>CW</th>
                        <th className='text-center' scope='col' style={{ minWidth: "100px" }}>CO5<br></br>Total</th>
                        <th className='text-center' scope='col' style={{ minWidth: "100px" }}><br></br>{ }</th>
                        <th className='text-center' scope='col' style={{ minWidth: "100px" }}>CO6<br></br>CW</th>
                        <th className='text-center' scope='col' style={{ minWidth: "100px" }}>CO6<br></br>Total</th>
                    </tr>
                </thead>
                <tbody>
