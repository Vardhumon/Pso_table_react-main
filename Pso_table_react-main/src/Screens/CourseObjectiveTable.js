...
function CourseObjectiveTable() {
    ...
    return (
        <div className="container-fluid w-75 border border-danger border-3 mt-4">
            <div className="row">
                <div className="col">
                    <div className="row text-light no-wrap fs-4 d-flex justify-content-center font-weight-bold" style={{backgroundColor:"#972119"}}>
                        <div className="col-6 fs-4 fw-bold border border-2 px-2 py-2 w-25">Sr.No</div>
                        <div className="col-5 fs-4 fw-bold border border-2 px-2 py-2 w-75">Course Objectives</div>
                    </div>
                    {data.map((item, index) => (
